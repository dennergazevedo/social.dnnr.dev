export const codeTip = [
  ...
  `   <span data-color="red" data-spacing="2">if</span>(attempt.error) <span data-color="red">throw new</span> <span data-color="blue">Error</span>(<span data-color="yellow">"Learn this"</span>, { <span data-color="red">cause</span>: attempt.error })`,
